...
const CategoryItems = ({ Ctg_Img, Ctg_title }) => {
...
const ProductItems = ({ type, title, guide_Img }) => {
...
const Product = () => {
  return <div>
    <div style={{border:"1px solid red", display: "flex",justifyContent:"space-evenly",margin:"auto" }}>
